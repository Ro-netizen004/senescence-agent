...
def compare_across_age(
    ...
    """
    Summarize dataset composition across age groups.

    Shows what cell types are present and how many
    cells exist per age group. Foundation for
    differential expression analysis across age.
    """
    ...
    ages = sorted(
        adata.obs[age_column].astype(str).unique().tolist()
    )
